...
// FXname:TArrStr; // імена змінних
 fHasPicture:boolean;
 procedure SetInputData(const Value: TVector);
...
public
 property InputData:TVector write SetInputData;
 property OutputData:TVector read fOutputData;
 property Error:boolean read fError;
 property Results:TArrSingle read fResults;
...
Procedure TFitFunction.SetInputData(const Value: TVector);
begin
 Value.CopyTo(fInputData);
end;
